...
The above bar-plot further examines the relationship of the change in political ideologies and the support for marijuana legalization. Although there is not strong enough evidence to state that beliefs on marijuana legalization ban will contribute to the change in political ideology, it appears that respondents who strongly support and support marijuana legalization tend to change their political ideologies. However, the correlation coefficient of `change` and `marijuana` is -0.002526195, suggesting a weak and negative linear relationship between the respondents' support for marijuana legalization and whether their political ideologies have changed since incarceration. In comparison, `weapons_ban` has a correlation coefficient of 0.11 with `change`, `border_security` 0.035, and 'min_wage` 0.048, all of which exhibits a positive linear relationship with whether the repondents' political ideologies have changed, although such relationships are not strong. 
